      ...
      <div className="container mx-auto max-w-6xl">
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <div className="flex items-center gap-2 text-terminal-gray font-mono text-sm">
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-terminal-green transition-colors">
                    {project.title}
                  </h3>
              ...
              {/* Features */}
              <div className="mb-4">
                <h4 className="text-terminal-green font-mono text-sm mb-2">Key Features:</h4>
                <ul className="space-y-1">
                  {project.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="text-terminal-text text-sm flex items-start gap-2">
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                <button className="flex items-center gap-2 text-terminal-gray hover:text-terminal-green transition-colors font-mono text-sm">
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 mt-4 text-terminal-cyan hover:text-cyan-400 transition-colors font-mono"
          >
            <Github className="w-5 h-5" />
